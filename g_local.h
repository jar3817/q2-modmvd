...
#include <ctype.h>
#include "regex.h"	// currently unused
...
// amount of time in seconds each frame represents
...
typedef struct
{
	...
	edict_t		*sight_client; // changed once each frame for coop game
